...
class Settings:
    ...
    def return_counter_setting(self, setting):
    ...
    def fetch_counter_settings(self):
        if self.settings:
    ...
    def fetch_network_settings(self):
        with open("/home/datecounter/Iris/.network_settings.json", "r") as setting_file:
            self.network_settings = json.load(setting_file)
