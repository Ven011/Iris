...
class Cupid:
    ...
    def work_tasks(self):
        ...
        for profile in self.base_profiles:
            # put weight text over dates profiles in ounces
            cv2.putText(self.compare_frame, str(round((profile.est_weight * 0.03527396), 2)), tuple(profile.position), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
